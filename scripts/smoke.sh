...
check "/assistant"    "Portfolio Assistant"    "assistant page renders"
check "/assistant"    "LangGraph"              "assistant page references LangGraph"
...
check "/sitemap.xml"  "nwalker.cc/assistant"   "sitemap includes assistant"
